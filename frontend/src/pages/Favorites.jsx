...
import FavEndBg from '../assets/img/fav-bg-end.jpg';
...
const Favorites = () => {
  ...
  return (
    <div className='min-h-screen md:px-10 py-10 bg-yellow-100'>
      ...
      <div className='
        md:mt-7 bg-cover bg-center 
        mt-7 
        md:min-h-[90vh]'
        style={{ backgroundImage: `url(${FavHeroBg})`}}
      >
        <div className='
          grid grid-cols-[70%_30%] 
          flex items-center h-[100%] md:min-h-[90vh]
          bg-linear-to-r from-stone-950/75 via-amber-950/75 to-yellow-900/50
        '>
      ...
      <div className='md:min-h-[30em] bg-stone-950 flex flex-col-reverse md:flex-row items-center'>
        ...
        <div className='md:w-[50%] flex items-center border-r-5 border-b-4 border-yellow-200 md:mx-5 md:my-10'>
          <h2 className='
            ...
            font-thin border-l-7 border-t-5 border-yellow
      ...
      <div className='grid grid-rows-2 md:grid-rows-1 md:grid-cols-[60%_40%] bg-linear-to-r from-stone-950/75 via-amber-950/75 to-yellow-900/50 md:min-h-[70vh] border-2'>
        ...
        <div className='row-start-1 py-10'>
          ...
          <div className='grid grid-cols-2 md:grid-cols-1 text-center flex flex-col gap-3 textmd md:text-2xl'>
            ...
            <p className='cursor-pointer hover:underline underline-offset-1 hover:text-shadow-md text-shadow-yellow-100/75 duration-500 ease-in-out' onMouseOver={() => hoverFavorite("fav4")} onMouseOut={() => hoverFavorite(null)}>Pancit Palabok</p>
            <p className='cursor-pointer hover:underline underline-offset-1 hover:text-shadow-md text-shadow-yellow-100/75 duration-500 ease-in-out' onMouseOver={() => hoverFavorite("fav5")} onMouseOut={() => hoverFavorite(null)}>Halo Halo</p>
            <p className='cursor-pointer hover:underline underline-offset-1 hover:text-shadow-md text-shadow-yellow-100/75 duration-500 ease-in-out' onMouseOver={() => hoverFavorite("fav6")} onMouseOut={() => hoverFavorite(null)}>Sinigang na Bangus</p>
            <p className='cursor-pointer hover:underline underline-offset-1 hover:text-shadow-md text-shadow-yellow-100/75 duration-500 ease-in-out' onMouseOver={() => hoverFavorite("fav7")} onMouseOut={() => hoverFavorite(null)}>Pinakbet</p>
            <p className='cursor-pointer hover:underline underline-offset-1 hover:text-shadow-md text-shadow-yellow-100/75 duration-500 ease-in-out' onMouseOver={() => hoverFavorite("fav8")} onMouseOut={() => hoverFavorite(null)}>Adobong Manok</p>
          </div>
        </div>
      </div>
